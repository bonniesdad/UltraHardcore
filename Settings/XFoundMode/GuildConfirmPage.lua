...
local function CreateGuildConfirmPage(parentFrame)
  ...
  descriptionText:SetText(
    'Guild Found mode will restrict all trading, mail, and auction house usage to guild members only. This cannot be changed once confirmed.'
  )
