...
local function CreateGroupConfirmPage(parentFrame)
  ...
  descriptionText:SetText(
    'Group Found mode will restrict all trading and mail usage to manually selected players only. You will need to add trusted players to your trading list. This cannot be changed once confirmed.'
  )
  ...
  confirmButton:SetScript('OnClick', function()
    ...
    print(
      '|cff00ff00Group Found mode activated!|r Trading is now restricted to party members only.'
    )
