...
PATCH_NOTES = {
  {
    ...
    notes = {
      ...
      '• Group Found',
      '• UHC Raid Frames',
      '• Player Verification Panel',
      '  • At the top of the statistics panel you can see the validity of your ultra character.',
      '• Added a new command for verification of party members',
      '  • /uhcverify',
      '  • This command will verify the party members and print the result to the chat.',
      '  • This command will be ran on party initiation.',
      '',
      'NEW STATISTICS:',
