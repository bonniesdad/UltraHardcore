-- Reusable Ko-fi donate dialog and button helpers

UHC_KofiInvite = UHC_KofiInvite or {}

do
  local dialogFrame
  local editBox
  local kofiUrl = 'https://ko-fi.com/bonniesdad'

  function UHC_KofiInvite_ShowDialog()
    ...
    if not dialogFrame then
      dialogFrame = CreateFrame('Frame', 'UltraHardcoreKofiDialog', UIParent, 'BackdropTemplate')
      ...
      message:SetText('Copy the donation link below and paste it into your web browser:')
  ...
  function UHC_CreateKofiInviteButton(
  parent,
    point,
    relativeTo,
    relativePoint,
    ...
    button:SetText(label or 'Donate')
    button:SetScript('OnClick', function()
      UHC_KofiInvite_ShowDialog()
    end)
    return button
  end
end
