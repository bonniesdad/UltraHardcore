-- Reusable TBC questionnaire dialog and button helpers

UHC_TBCQuestionnaire = UHC_TBCQuestionnaire or {}

do
  local dialogFrame
  local editBox
  local questionnaireUrl = 'https://bonniesdad.web.app/wow/the-burning-crusade'

  function UHC_TBCQuestionnaire_ShowDialog()
    ...
    if not dialogFrame then
      ...
      title:SetText('TBC Questionnaire')
      ...
      message:SetText('Copy the questionnaire link below and paste it into your web browser:')
      ...
      editBox:SetText(questionnaireUrl)
  ...
  function UHC_CreateTBCQuestionnaireButton(
  parent,
    point,
    relativeTo,
    relativePoint,
    ...
    button:SetText(label or 'TBC Questionnaire')
    button:SetScript('OnClick', function()
      UHC_TBCQuestionnaire_ShowDialog()
    end)
    return button
  end
end
